...
Cổng thông tin dạng tài liệu hướng dẫn (Static Web Portal) cung cấp hướng dẫn chi tiết quy trình liên kết các loại tài khoản (Cá nhân, Doanh nghiệp, Hộ kinh doanh) với hệ thống Tingee cho 13 ngân hàng tại Việt Nam.
...
- **VietQR Logo API** — Tự động hiển thị logo của 13 ngân hàng qua `api.vietqr.io`.
...
| File | Purpose |
|---|---|
| `pages/home.html` | Trang chủ cổng thông tin hướng dẫn |
| `pages/bank.html` | Trang chi tiết hướng dẫn liên kết 13 ngân hàng |
